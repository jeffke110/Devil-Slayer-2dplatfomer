var lvl_one_enemies = [];
/*
level one enemy class that represents the eye ball monster in the first level. Uses a very simple AI. This is just a based class for other classes in the system 
*/
