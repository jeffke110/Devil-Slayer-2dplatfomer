/*
collision with the player of the game functions
*/
...
title_screen_player.prototype._check_door = function () {
    if (in_lvl_one == true) {
        var posX = tilemap_lvl_one.position.x + 300;
        if(posX > lvl_one_door_obj.x && posX < lvl_one_door_obj.x + lvl_one_door_obj.width && this.position.y > lvl_one_door_obj.y){
            in_lvl_one_door = true;
        }else{
