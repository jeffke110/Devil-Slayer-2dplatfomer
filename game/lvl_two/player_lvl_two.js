title_screen_player.prototype._check_two_block = function () {
    if (in_lvl_two == true) {
        var posX = tilemap_lvl_two.position.x + 300
...
title_screen_player.prototype._check_two_ground = function () {
    if (in_lvl_two == true) {
        var posX = tilemap_lvl_two.position.x + 300;
...
title_screen_player.prototype._check_two_door = function () {
    if (in_lvl_two == true) {
        var posX = tilemap_lvl_two.position.x + 300;
        if(posX > lvl_two_door_obj.x && posX < lvl_two_door_obj.x + lvl_two_door_obj.width && this.position.y > lvl_two_door_obj.y){
            in_lvl_two_door = true;
        }else{
